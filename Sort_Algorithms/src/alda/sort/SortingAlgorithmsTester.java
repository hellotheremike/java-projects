...
public class SortingAlgorithmsTester {
	 ...
	 */
	private static final double MAX_TIME_FOR_TEST_IN_SECONDS = 30.0;
	 ...
	 */
	private static final int[] SIZES = { //100, 500, 1000, 2000, 4000, 
		10000,
			//20000, 50000, 
			//100000
