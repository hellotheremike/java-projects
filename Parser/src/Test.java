...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		String[] exprs = new String[] { "a = 5 - 2", "b= 1+ 2", "c=1*2+11/2", "d=(2+3)-(10*(20-3))" };
		...
		for (int n = 0; n < exprs.length; n++) {
			...
			Scanner sc = new MyScanner(new StringReader(expr));
			Tokenizer to = new MyTokenizer(sc);
			
			Parser pa = new MyParser(to);
			Node root = pa.parse();
